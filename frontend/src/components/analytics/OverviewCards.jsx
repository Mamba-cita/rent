...
const overviewData = [
	...
	{ name: "New Tenants", value: "45,678", change: 8.3, icon: Users },
	{ name: "Other Charges", value: "9,876", change: -3.2, icon: ShoppingBag },
	{ name: "Tenants", value: "1,234,567", change: 15.7, icon: Eye },
];
